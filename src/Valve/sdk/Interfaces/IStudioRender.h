...
public:
	...
	{
		Memory::vmt::Call<void>(this, 27, color);
	}

	constexpr void SetAlphaModulation(const float alpha) noexcept
	{
		Memory::vmt::Call<void>(this, 28, alpha);
	}
	...
	{
		Memory::vmt::Call<void>(this, 33, material, type, index);
	}

	constexpr bool IsForcedMaterialOverride() noexcept
	{
		return Memory::vmt::Call<bool>(this, 34);
	}
};