...
std::uint8_t* Memory::Pattern::Scan(const char* moduleName, const char* pattern) noexcept
{
...
void Memory::Setup()
{
	allocKeyValuesClient = Pattern::Scan("client.dll", "FF 52 04 85 C0 74 0C 56") + 3;
	allocKeyValuesEngine = Pattern::Scan("engine.dll", "FF 52 04 85 C0 74 0C 56") + 3;
}